...
import { useCurrentProfile, useCloudStatus } from "../../../hooks/queries";
import { Loader2, User, Mail, IdCard, Smartphone, Fingerprint, Wifi, Copy, Check } from "lucide-react";
      ...
      <div className="flex min-w-0 flex-1 items-center justify-between gap-2">
        ...
        <span className="flex items-center gap-1.5">
          ...
          <button
            ...
            className="shrink-0 rounded p-0.5 text-oa-text-muted transition-colors hover:text-oa-text hover:bg-oa-surface-2"
            title={`Copy ${label}`}
