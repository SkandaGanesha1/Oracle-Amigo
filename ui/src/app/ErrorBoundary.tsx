...
export class ErrorBoundary extends Component<ErrorBoundaryProps, ErrorBoundaryState> {
  ...
  render() {
    ...
    return (
      <main className="flex min-h-screen items-center justify-center bg-oa-bg p-6 text-oa-text" role="alert">
        <section className="w-full max-w-md rounded-lg border border-oa-red/30 bg-oa-surface p-5 shadow-xl">
          <div className="flex items-start gap-3">
            ...
            <div className="min-w-0">
              <h1 className="text-base font-semibold text-oa-text">Something went wrong</h1>
              <p className="mt-1 text-sm text-oa-text-muted">
                The chat UI hit a rendering error. Your local agent state is still intact.
              </p>
